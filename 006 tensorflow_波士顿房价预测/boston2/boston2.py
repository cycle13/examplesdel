...
print('sklearn duocengganzhiji-huigui-model score',mlp_score)
...
print('sklearn jicheng-huigui-model score',gbr_score_disorder)#准确率较高 0.853817723868
...
line1,=axes.plot(range(len(gbr_pridict_disorder)), gbr_pridict_disorder, 'b--',label='jichengmodel',linewidth=2)
line2,=axes.plot(range(len(mlp_pridict_disorder)), mlp_pridict_disorder, 'r--',label='duocengganzhiji',linewidth=2)
axes.grid()
fig.tight_layout()
plt.legend(handles=[line1, line2,line3])
#plt.legend(handles=[line1,  line3])
plt.title('sklearn huigui_model')
plt.show()
